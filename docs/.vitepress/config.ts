...
export default defineConfig({
  title: 'Klexir.EventFlow',
  description: 'Strongly typed event bus for the Klexir ecosystem',
  base: '/Klexir.EventFlow/',
  cleanUrls: true,
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'Klexir.EventFlow' }],
    ['meta', { property: 'og:description', content: 'Strongly typed event bus for the Klexir ecosystem' }],
  ],

  themeConfig: {
    siteTitle: 'Klexir.EventFlow',
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/Danny4897/Klexir.EventFlow' },
    ],
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/Danny4897/Klexir.EventFlow' },
    ],
